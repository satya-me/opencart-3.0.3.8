<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellerlogin extends Controller
{
	private $error = array();
	...
	public function index()
	{
		...
		if ($this->customer->isLogged()) {
			...
			$this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerregister', '', true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerlogin', '', true)
		);
		...
		$data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerlogin', '', true);
		$data['sellerregister'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerregister', '', true);
		...
		$this->response->setOutput($this->load->view('web/account/purpletree_multivendor/sellerlogin', $data));
	}
