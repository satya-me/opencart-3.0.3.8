<?php
class ControllerWebExtensionAccountPurpletreeMultivendorDashboardicons extends Controller {
		private $error = array();
		
		public function index(){
			
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/dashboardicons', '', true);
			...
			'href' => $this->url->link('web/extension/account/purpletree_multivendor/dashboardicons', $url, true)
			);
			...
			$data['sellerprofile'] = $this->url->link('web/extension/account/edit', '', true);
			$data['downloadsitems'] = $this->url->link('web/extension/account/purpletree_multivendor/downloads', '', true);
			$data['sellerstore'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore', '', true);
			$data['sellerproduct'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerproduct', '', true);
			$orderstatus = 0;
			$end_date_to = date('Y-m-d');
			$end_date_from = date('Y-m-d', strtotime("-30 days"));				
			$data['sellerorder'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerorder', 'filter_date_from='.$end_date_from.'&filter_date_to=' .$end_date_to.'', true);
			$data['sellercommission'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercommission', '', true);
			$data['sellerpayment'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerpayment', '', true);
			$data['removeseller'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/removeseller', '', true);
			$data['becomeseller'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/becomeseller', '', true);
			$data['sellerview'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview&seller_store_id='.$store_id, '', true);
			$data['sellerreview'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/sellerreview', '', true);
			$data['sellerenquiry'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercontact/sellercontactlist', '', true);
			$data['dashboardicons'] = $this->url->link('web/extension/account/purpletree_multivendor/dashboardicons', '', true);
			$data['dashboard'] = $this->url->link('web/extension/account/purpletree_multivendor/dashboard', '', true);
			...
			if($this->config->get('module_purpletree_multivendor_subscription_plans')==1){
				...
				$data['subscriptionplan'] = $this->url->link('web/extension/account/purpletree_multivendor/subscriptionplan', '', true);
				
				$data['subscriptions'] = $this->url->link('web/extension/account/purpletree_multivendor/subscriptions', '', true);
			...
			if($this->config->get('module_purpletree_sellerblog_status')){
				$data['sellerblogpost'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogpost', '', true);
				$data['sellerblogcomment'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerblogcomment', '', true);
			}
			$data['commissioninvoice'] = $this->url->link('web/extension/account/purpletree_multivendor/commissioninvoice', '', true);
			...
			if($data['module_purpletree_multivendor_seller_product_template'] == 1){
				$data['seller_template_product'] = $this->url->link('web/extension/account/purpletree_multivendor/sellertemplateproduct', '', true);
			}
