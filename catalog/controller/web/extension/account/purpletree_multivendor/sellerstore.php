<?php
class ControllerWebExtensionAccountPurpletreeMultivendorSellerstore extends Controller
{
    private $error = array();
    ...
    public function index()
    {
        if (!$this->customer->isLogged()) {
            $this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore', '', true);
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerstore', '', true));
        }
        $data['breadcrumbs'] = array();

        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('text_home'),
            'href' => $this->url->link('web/common/home', '', true),
        );

        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('text_store'),
            'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore', '', true),
        );
        ...
        $data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore', '', true);
        ...
        //echo "<pre>";
        //print_r($data['account_custom_field']);
        //die;
        ...
        $this->response->setOutput($this->load->view('web/account/purpletree_multivendor/seller_store', $data));
    }
    ...
    {
        if (!$this->customer->isLogged()) {
            $this->session->data['redirect'] = $this->url->link('web/account/purpletree_multivendor/becomeseller', '', true);
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateSeller()) {
            ...
            $mail->setText($this->load->view('web/account/purpletree_multivendor/register_mail', $data));
            $mail->send();
            ...
            if (in_array('account', (array) $this->config->get('config_mail_alert'))) {
                ...
                $mail->setText($this->load->view('web/account/purpletree_multivendor/register_alertmail', $data));
                $mail->send();
        ...
        if ($isSeller) {
            ...
            if ($isSeller['is_removed']) {
                $data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/reseller', '', true);
                $data['is_removed'] = 1;
            } elseif ($isSeller['store_status'] == 1) {
                $this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/dashboardicons', '', true));
            }
        } else {
            $data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/becomeseller', '', true);
            $data['is_removed'] = 0;
        }
        ...
        $this->response->setOutput($this->load->view('web/account/purpletree_multivendor/seller_form', $data));
    }
    ...
    public function storeview()
    {
        ...
        if (isset($this->request->get['p_url'])) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview&seller_store_id=' . $sellerstore . '&p_url=' . $this->request->get['p_url'], '', true),
            );
        } else {
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('text_storeview'),
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview&seller_store_id=' . $sellerstore, '', true),
            );
        }
        $data['storepage_layout'] = $this->config->get('module_purpletree_multivendor_storepage_layout');
        ...
        //echo"<pre>"; print_r($store_detail); die;
        $data['module_purpletree_multivendor_allow_live_chat'] = 0;
        if (null !== $this->config->get('module_purpletree_multivendor_allow_live_chat')) {
            $data['module_purpletree_multivendor_allow_live_chat'] = $this->config->get('module_purpletree_multivendor_allow_live_chat');
        }
        ...
        if ($store_detail and ($store_detail['store_status'] == 1)) {
            ...
            $data['store_review'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/sellerreview', 'seller_id=' . $store_detail['seller_id'], true);

            $data['store_shipping_policy'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storedesc', 'path=shippingpolicy' . '&seller_store_id=' . $store_detail['id'], true);

            $data['store_return_policy'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storedesc', 'path=returnpolicy' . '&seller_store_id=' . $store_detail['id'], true);

            $data['store_about'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storedesc', 'path=aboutstore' . '&seller_store_id=' . $store_detail['id'], true);

            $data['seller_contact'] = $this->url->link('web/extension/account/purpletree_multivendor/sellercontact/customerReply', 'seller_id=' . $store_detail['seller_id'], true);
            ...
            $data['allCategory'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&seller_store_id=' . $this->request->get['seller_store_id'], true);
                ...
                foreach ($categoryMenu as $category_key => $category_value) {
                    if ($category_value['category_id']) {
                        $data['storeMenu'][] = array(
                            'url' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&seller_store_id=' . $this->request->get['seller_store_id'] . '&p_url=' . $category_value['category_id'], true),
            ...
            $templateproducts = $this->model_extension_module_purpletree_sellerprice->getTemplateProduct($seller_store_id);
            //echo"<pre>"; print_r($templateproducts); die;
            $countttt = 0;
            if (isset($templateproducts)) {
                foreach ($templateproducts as $templateproduct) {
                    ...
                    $templateproductss[] = array(
                        'href' => $this->url->link('web/product/product', 'product_id=' . $templateproduct['product_id'] . $conditu, true),
            ...
            //echo"<pre>"; print_r($templateproductss); die;
            ...
            //echo"<pre>"; print_r($seller_products); die;
            ...
            if ($seller_products) {
                ...
                foreach ($seller_products as $seller_product) {
                    ...
                    if (!empty($seller_detailss)) {
                        ...
                        $seller_link = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', 'seller_store_id=' . $seller_detailss['id']);
                    ...
                    $data['seller_products'][] = array('seller_name' => isset($seller_detail['seller_name']) ? $seller_detail['seller_name'] : '',
                        ...
                        'quick_order' => $this->url->link('web/extension/account/purpletree_multivendor/quick_order', '&product_id=' . $seller_product['product_id'] . $url, true),
                        'href' => $this->url->link('web/product/product', 'product_id=' . $seller_product['product_id'] . $conditu, true),
                        'thumb' => $image,
                        'thumb2' => $image2,
            ...
            $data['sorts'][] = array(
                ...
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&sort=p.sort_order&order=ASC' . $url . '&seller_store_id=' . $sellerstore, true),
            );

            $data['sorts'][] = array(
                'text' => $this->language->get('text_name_asc'),
                'value' => 'pd.name-ASC',
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&sort=pd.name&order=ASC' . $url . '&seller_store_id=' . $sellerstore, true),
            );

            $data['sorts'][] = array(
                'text' => $this->language->get('text_name_desc'),
                'value' => 'pd.name-DESC',
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&sort=pd.name&order=DESC' . $url . '&seller_store_id=' . $sellerstore, true),
            );

            $data['sorts'][] = array(
                'text' => $this->language->get('text_price_asc'),
                'value' => 'p.price-ASC',
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&sort=p.price&order=ASC' . $url . '&seller_store_id=' . $sellerstore, true),
            );

            $data['sorts'][] = array(
                'text' => $this->language->get('text_price_desc'),
                'value' => 'p.price-DESC',
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&sort=p.price&order=DESC' . $url . '&seller_store_id=' . $sellerstore, true),
            );

            $data['sorts'][] = array(
                'text' => $this->language->get('text_model_asc'),
                'value' => 'p.model-ASC',
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&sort=p.model&order=ASC' . $url . '&seller_store_id=' . $sellerstore, true),
            );

            $data['sorts'][] = array(
                'text' => $this->language->get('text_model_desc'),
                'value' => 'p.model-DESC',
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&sort=p.model&order=DESC' . $url . '&seller_store_id=' . $sellerstore, true),
            );
            ...
            foreach ($limits as $value) {
                $data['limits'][] = array(
                    'text' => $value,
                    'value' => $value,
                    'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', $url . '&limit=' . $value . '&seller_store_id=' . $sellerstore, true),
                );
            }
            ...
            $pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', $url . '&page={page}', true);
            ...
            if ($page == 1) {
                $this->document->addLink($this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&seller_store_id=' . $sellerstore, true), 'canonical');
            } elseif ($page == 2) {
                $this->document->addLink($this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&seller_store_id=' . $sellerstore, true), 'prev');
            } else {
                $this->document->addLink($this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&seller_store_id=' . $sellerstore . '&page=' . ($page - 1), true), 'prev');
            }

            if ($limit && ceil($toatl_seller_products / $limit) > $page) {
                $this->document->addLink($this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storeview', '&seller_store_id=' . $sellerstore . '&page=' . ($page + 1), true), 'next');
            }
            ...
            $data['footer'] = $this->load->controller('web/common/footer');
            $data['header'] = $this->load->controller('web/common/header');
            $this->response->setOutput($this->load->view('web/account/purpletree_multivendor/storeview', $data));
        } else {
            ...
            $data['continue'] = $this->url->link('web/common/home', '', true);
    ...
    public function storedesc()
    {
        ...
        if ($store_info) {
            if ($this->request->get['path'] == "shippingpolicy") {
                $data['breadcrumbs'][] = array(
                    ...
                    'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/storedesc&path=' . $this->request->get['path'] . '&seller_store_id=' . $store_id, '', true),
                );
        ...
        $this->response->setOutput($this->load->view('web/account/purpletree_multivendor/policy', $data));
    }
    ...
    public function removeseller()
    {
        ...
        if (!$this->customer->isLogged()) {
            $this->session->data['redirect'] = $this->url->link('web/account/purpletree_multivendor/sellerstore/removeseller', '', true);

            $this->response->redirect($this->url->link('web/account/login', '', true));
        }
        if (!$this->customer->isLogged()) {
            $this->session->data['redirect'] = $this->url->link('web/extension/account/purpletree_multivendor/removeseller', '', true);
            $this->response->redirect($this->url->link('web/account/login', '', true));
        }
        $store_detail = $this->customer->isSeller();
        if (!isset($store_detail['store_status'])) {
    ...
    public function sellerreview()
    {
        ...
        if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validateReview()) {
            ...
            $this->response->redirect($this->url->link('web/extension/account/purpletree_multivendor/sellerstore/sellerreview&seller_id=' . $this->request->post['seller_id'], '', true));
        }
        ...
        if (isset($this->request->get['seller_id'])) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/sellerreview&seller_id=' . $this->request->get['seller_id'], '', true),
            );
            ...
            $data['action'] = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/sellerreview&seller_id=' . $data['seller_id'], '', true);
            ...
            $pagination->page = $page;
            $pagination->limit = $limit;
            $pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/sellerreview', 'seller_id=' . $data['seller_id'] . '&page={page}', true);
            ...
            $this->response->setOutput($this->load->view('web/account/purpletree_multivendor/review', $data));
        } else {
            if ($this->customer->isSeller()) {
                ...
                $data['breadcrumbs'][] = array(
                    'text' => $this->language->get('text_storereview'),
                    'href' => $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/sellerreview', '', true),
                );
                $filter_data = array(
                    'start' => ($page - 1) * $limit,
                    'limit' => $limit,
                ...
                $pagination->page = $page;
                $pagination->limit = $limit;
                $pagination->url = $this->url->link('web/extension/account/purpletree_multivendor/sellerstore/sellerreview', 'page={page}', true);
                ...
                $this->response->setOutput($this->load->view('web/account/purpletree_multivendor/reviewlist', $data));
            }
        }
    }
